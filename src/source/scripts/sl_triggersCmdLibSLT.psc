...
; sltgrup NiOverride
; sltdesc use NiOverride to get free overlay slot
; sltargs actor: target Actor
...
; sltgrup NiOverride
; sltdesc use NiOverride to params overlays
; sltargs actor: target Actor
; sltargs isFemale : bool
; sltargs nodeName (see getoverlay function) : string
...
; sltgrup NiOverride
; sltdesc use NiOverride to change overlay transparency
; sltargs actor: target Actor
; sltargs isFemale : bool
; sltargs nodeName (see getoverlay function) : string
; sltargs transparency : float
...
; sltgrup NiOverride
; sltdesc use NiOverride to remove overlay
; sltargs actor: target Actor
; sltargs isFemale : bool
; sltargs nodeName (see getoverlay function) : string
; sltargs transparency : float
...
; sltgrup NiOverride
; sltdesc use NiOverride to apply change/parameters to overlay in previous functions
; sltargs actor: target Actor
